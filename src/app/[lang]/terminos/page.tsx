        ...
        <div className="space-y-12 text-base md:text-lg leading-relaxed text-zinc-400 font-light">
          ...
          {terms.sections.map((section, index) => (
            <section key={index}>
              ...
              {/* Renderiza la lista si existe (como en la sección de Metodología) */}
              {section.list && section.list.length > 0 && (
                <ul className="list-none space-y-4 pl-0 mt-4">
                  {section.list.map((listItem, lIndex) => {
                    // Un pequeño truco para poner en negrita el título del item (ej: "Fases de revisión:")
          ...
          <section className="mt-16 pt-8 border-t border-white/5">
            ...
            <p>
              {terms.contact.text}{' '}
              <a href={`mailto:${terms.contact.email}`} className="text-[#E11D48] hover:text-white transition-colors relative pb-1 group inline-block">
                {terms.contact.email}
